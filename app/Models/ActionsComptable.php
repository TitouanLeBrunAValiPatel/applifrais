...
class ActionsComptable extends Model {
	...
	*/
	...
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
        ...
        public function getLesFichesDesVisiteurs()
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
	...
	*/
	...
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
	    ...
	    $this->dao->signeFiche($id, $mois);
	}
        public function refuseFiche($id, $mois, $comment)
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
		// TODO : intégrer une fonctionnalité d'impression PDF de la fiche

	    $this->dao->refuseFiche($id, $mois, $comment);
	}
	...
	*/
	...
	public function leStatut($idStatut){
		$statutC = $this->dao->getLeStatut($idStatut);
		if($statutC == 1)
		{
			return "Comptable";
		}
	...
	{	// TODO : s'assurer que les paramètres reçus sont cohérents avec ceux mémorisés en session
            ...
            $res['lesEtats'] = $this->dao->getLesEtats();
            return $res;
	}
